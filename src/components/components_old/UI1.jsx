...
// import { useConfiguratorStore, pb } from "../store.jsx";
...
//     return (
//         <button className="rounded-lg bg-indigo-500 hover:bg-amber-600 transition-colors duration-300 text-white font-medium px-4 py-3 pointer-events-auto">
//             Download
//         </button>
//     )
// }
...
// export const UI = () => {
//     return (
//         <main className="pointer-events-none fixed inset-0 z-10 p-10">
...
//                     >
//                         <img className="w-17" src="/images/b&b_logo.png" />
//                     </a>
//                     <DownloadButton />
//                 </div>
